...
// "thebase table.
        HTable table = new HTable(config, "thebase");
...
// the below, we are converting the String "_id" into a byte
...
// If no timestamp, the server applies current time to the edits.
        Put p = new Put(Bytes.toBytes("_id"));

// To set the value you'd like to update in the row '_id',
...
// package up the hbase return into the form you find most palatable.
        Get g = new Get(Bytes.toBytes("_id"));
